...
<head>
    ...
    <title>Kins Blog | Dashbiard Kelola Konten</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                    ...
                    <div class=container>
                        Silahkan Pilih salah satu menu<br><br>
                    </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                ...
                                                //tampilkan hasil
                                                //echo " Jumlah record dalam tabl :$count ";
                                                 ?>
                                                <a class="nav-link" href="artikel.php"><?php echo $count . ' Artikel' ?></a>
                                                <!--<div class="h5 mb-0 font-weight-bold text-gray-800">20 Artikel</div> -->
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                ...
                                                //echo " Jumlah record dalam tabl :$count ";
                                                 ?>
                                                <a class="nav-link" href="kategori.php"><?php echo $count . ' Kategori' ?></a>
                                            <!-- <div class="h5 mb-0 font-weight-bold text-gray-800">$215,000</div> -->
                                        </div>
                                        <div class="col-auto">
                                            <i class="bi bi-bookmarks fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Penulis
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <?php 
                                                ...
                                                //echo " Jumlah record dalam tabl :$count ";
                                                 ?>
                                                <a class="nav-link" href="penulis.php"><?php echo $count . ' Penulis' ?></a>
